  ...
  return (
    <div style={{ 
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        {/* 主要内容 */}
        <div style={{ textAlign: 'center', marginBottom: token.marginXXL }}>
          {/* 英雄区域 */}
          <div style={{ marginBottom: token.marginXXL }}>
            <div style={{ 
              ...
              <div style={{ position: 'relative' }}>
                ...
                <div style={{ 
                  ...
                  width: 24, 
                  height: 24, 
                  background: `linear-gradient(135deg, ${token.colorWarning}, ${token.colorError})`,
                  borderRadius: '50%',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
            ...
            <Title level={1} style={{ marginBottom: token.margin }}>
              <span style={{ background: `linear-gradient(135deg, ${token.colorPrimary}, ${token.colorPrimaryActive})`, WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                AI驱动的
              </span>
              <br />
              智能投标平台
            ...
            <Paragraph style={{ fontSize: 18, color: token.colorTextSecondary, marginBottom: token.marginLG }}>
              ...
              {features.map((feature, index) => (
                <Col xs={24} sm={12} lg={6} key={feature.title}>
                  ...
                  >
                    ...
                    <Title level={4} style={{ marginBottom: token.marginXS }}>{feature.title}</Title>
