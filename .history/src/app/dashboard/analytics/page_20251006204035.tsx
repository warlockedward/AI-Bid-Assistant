  ...
  return (
    <div style={{ padding: '24px' }}>
      ...
      <Row gutter={[24, 24]} style={{ marginBottom: '24px' }}>
        ...
        <Col xs={24} sm={12} md={12} lg={4.8}>
          <Card>
            ...
            />
            <Text type="secondary" style={{ fontSize: '12px' }}>+2.3% 较上月</Text>
          </Card>
        </Col>
        ...
        <Col xs={24} sm={12} md={12} lg={4.8}>
          <Card>
            ...
            />
            <Text type="secondary" style={{ fontSize: '12px' }}>+15% 较上月</Text>
          </Card>
        </Col>
        ...
        <Col xs={24} sm={12} md={12} lg={4.8}>
          <Card>
            ...
            />
            <Text type="secondary" style={{ fontSize: '12px' }}>-0.8天 较上月</Text>
          </Card>
        </Col>
      </Row>
      ...
      <Row gutter={[24, 24]} style={{ marginBottom: '24px' }}>
        {/* 月度趋势 */}
        <Col xs={24} lg={12}>
          <Card title={<Space><RiseOutlined />月度投标趋势</Space>}>
            <List
