...
def get_config_module():
    ...
    try:
        ...
        import config
        return config.ModelProvider, get_tenant_config
    except ImportError:
        ...
        try:
            ...
            def get_tenant_config(tenant_id, provider=None, model_name=None):
                return {
...
class AgentWorkflowManager:
    ...
    async def start_workflow(
        ...
        if model_provider is None:
            model_provider = ModelProvider.OPENAI  # type: ignore
