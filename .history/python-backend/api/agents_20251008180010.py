...
async def analyze_tender_document(request: TenderAnalysisRequest):
    ...
    try:
        ...
        TenderAnalysisAgent = getattr(tender_agent_module, "TenderAnalysisAgent")
...
async def retrieve_knowledge(
    ...
    try:
        ...
        # Create agent instance
        KnowledgeRetrievalAgent = getattr(knowledge_agent_module, "KnowledgeRetrievalAgent")
...
async def generate_content(
    ...
    try:
        ...
        # Create agent instance
        ContentGenerationAgent = getattr(content_agent_module, "ContentGenerationAgent")
...
async def verify_compliance(
    ...
    try:
        ...
        # Create agent instance
        ComplianceVerificationAgent = getattr(compliance_agent_module, "ComplianceVerificationAgent")
