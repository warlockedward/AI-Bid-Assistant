...
def get_tenant_context(
    ...
    user_id = authorization.replace("Bearer ", "") if authorization.startswith("Bearer ") else authorization
    ...
    try:
        ...
        if existing_workflow:
            ...
            return {
                ...
                "updated_at": updated_workflow.updated_at.isoformat() if updated_workflow else None
            }
        else:
            # Create new workflow
...
async def report_workflow_error(
    ...
    try:
        ...
        return {
            ...
            "failed_at": failed_workflow.completed_at.isoformat() if failed_workflow.completed_at else None
        }
